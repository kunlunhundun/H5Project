...
let homeData = {
    ...
    data: {
        lineList: [
            {
                icon: "../../assets/sirius/icon_china_flag.png",
                title: 'USA line',
                ischeck: 0
            }, {
                icon: "../../assets/sirius/icon_china_flag.png",
...
let appsData = {
    ...
    data: [
        {
            iconDelete: "../../assets/sirius/icon_delete.png",
            iconApp: "../../assets/sirius/ic_launcher_round.png",
            name: 'wechat',
        },
        {
            iconDelete: "../../assets/sirius/icon_delete.png",
...
Mock.mock('/lines/data', 'post', linesData)
Mock.mock('/apps/data', 'post', appsData)
